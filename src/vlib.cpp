...
namespace vlib {
  ...
  class two {
    ...
    static void ArmUp(vlib::motor leftMotor, vlib::motor rightMotor, vex::controller::button R1)
    {
      if (R1.pressing())
      {
    ...
    static void ArmDown(vlib::motor leftMotor, vlib::motor rightMotor, vex::controller::button R2)
    {
      if (R2.pressing())
      {
